# Cloud Services - Weekly Assignment 4

Three-tier web application deployed on CSC Rahti using OpenShift/Kubernetes.

The application was created for the Week 4 assignment of the Cloud Services course at Oulu University of Applied Sciences.
...
```text
iagoprolg/cloud-services-week4-frontend
iagoprolg/cloud-services-week4-backend
```
...
docker buildx build --platform linux/amd64 \
  ...
  -t iagoprolg/cloud-services-week4-frontend:1.0.1 \
  --push .
```
...
oc set image deployment/frontend \
  frontend=iagoprolg/cloud-services-week4-frontend:1.0.1
```
